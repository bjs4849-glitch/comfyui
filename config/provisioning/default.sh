...
CHECKPOINT_MODELS=(
    ...
    "https://civitai.com/api/download/models/1785408?type=Model&format=SafeTensor&size=pruned&fp=fp8"
...
LORA_MODELS=(
    ...
    "https://civitai.com/api/download/models/183382?type=Model&format=SafeTensor"
